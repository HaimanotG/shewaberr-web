...
export const Testimonial = ({ children, className = Styles.lc_testimonial }) => (
    <div
        className={className}
        >
        <div className={Styles.lc_testimonial__content}>
        <svg 
            fill="currentColor" 
            className={Styles.lc_testimonial__content__quote}
