...
export const Testimonials = () => (
    <div
        className="container px-5 py-24  w-full"
        >
        <Typography className="text-gray-700 font-bold text-7xl leading-snug">Testimonials</Typography>
        <div className="flex flex-row flex-wrap -m-4">
            <div
                className="p-4 md:w-1/2"
                >
                <div className="mt-12 h-full bg-gray-100 p-8 rounded flex y flex-col gap-4">
                <svg 
                    fill="currentColor" 
                    ...
                    viewBox="0 0 975.036 975.036">
                        ...
                        <a>
                            <Avatar className="pr-10" src="https://i.pravatar.cc/300"/>
